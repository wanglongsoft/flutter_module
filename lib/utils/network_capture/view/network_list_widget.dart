...
import '../../../utils/network_capture/adapter/capture_screen_adapter.dart';
import '../../../utils/network_capture/view/widget/remove_ripple_widget.dart';
import '../../../utils/network_capture/view/widget/request_item_widget.dart';
import '../../../utils/network_capture/view/widget/search_widget.dart';

import '../data/app_data.dart';
import '../data/network_history_table.dart';
import '../generated/assets/network_capture_assets.dart';
...
class _NetworkListWidgetState extends State<NetworkListWidget> {
  ...
  Future<void> _refresh(String? where, List<Object?>? whereArgs) async {
    final value = await AppData.instance.query();
    setState(() {
      list = value;
    });
  }
